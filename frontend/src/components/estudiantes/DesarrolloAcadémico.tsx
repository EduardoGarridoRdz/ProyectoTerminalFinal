...
export default function DesarrolloAcademico() {
        ...
        <Box>
            <Grid container spacing={2} sx={{ pl: 2, pt: 2 }}>
                ...
                <Grid container justifyContent="center">
                    <iframe
                        src="https://lookerstudio.google.com/embed/reporting/19b4d7b4-d026-4d42-bed0-b124173021e7/page/p_5t3jsywyrd"
                        title="Reporte Vinculación Académica"
                        allowFullScreen
                        style={{
                            flex: 1,
                            border: 0,
